package com.llahn.common.properties;
...
public class DruidProperties {
    ...
    /** 
     * @Fields username : 默认用户名
     */ 
    private String username = "test";

    /** 
     * @Fields password : 默认密码
     */ 
    private String password = "test";

    /** 
     * @Fields driverClassName : 默认数据库驱动
     */ 
